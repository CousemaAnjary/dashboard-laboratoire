                                            ...
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem>
                                                        ...
                                                        <FormControl>
                                                            <Input type="email" placeholder={field.value} onChange={field.onChange} className="bg-gray-50 focus:bg-white focus:outline-none border-none shadow placeholder:text-slate-500 font-inter rounded-sm dark:bg-zinc-950" />
                                                        </FormControl>
                                            ...
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem>
                                                        ...
                                                        <FormControl>
                                                            <Input {...field} placeholder="votre mot de passe" className="bg-gray-50 focus:bg-whit  border-none shadow placeholder:text-slate-500 font-inter rounded-sm dark:bg-zinc-950" />
                                                        </FormControl>
                                                        <FormMessage className="font-inter" />
                                                    </FormItem>
                                                )}
